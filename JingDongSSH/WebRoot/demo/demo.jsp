...
<DIV class=form><INPUT class=text id=key 
onkeydown="javascript:if(event.keyCode==13) search('key');" accessKey=s 
autocomplete="off"> <INPUT class=button onclick="search('key');return false;" type=button value=搜索> 
</DIV></DIV>
<DIV id=hotwords></DIV></DIV><!--search end-->
<DIV id=my360buy>
<DL>
  <DT class=ld><S></S><IMG height=24 src="image/blank.gif" 
  width=24><A href="http://home.360buy.com/">我的京东</A><B></B> </DT>
  <DD>
  <DIV class=loading-style1><B></B>加载中，请稍候...</DIV></DD></DL></DIV><!--my360buy end-->
<DIV id=settleup>
<DL>
  <DT class=ld><S><SPAN id=shopping-amount></SPAN></S><A 
  href="http://jd2008.360buy.com/purchase/ShoppingCart.aspx">去购物车结算</A> 
  <B></B></DT>
  <DD>
  <DIV class=prompt>
...
<DIV id=treasure></DIV>
<UL id=navitems>
  <LI class=fore1 id=nav-home><A href="http://www.360buy.com/">首页</A> </LI>
...
data-lazyload="http://img10.360buyimg.com/da/20110329/108_40_zZOKnl.gif"></A>
...
data-lazyload="http://img12.360buyimg.com/da/20110329/112_40_EAWZul.jpg"></A><A 
href="http://fzp.bjhd.gov.cn/Default.aspx?TabId=105" target=_blank><IMG 
height=40 alt=海淀网络警察 width=108 
data-lazyload="http://img11.360buyimg.com/da/20110329/108_40_OaNIwt.jpg"></A><A 
href="https://search.szfw.org/cert/l/CX20120111001803001836" target=_blank><IMG 
height=40 width=112 
data-lazyload="http://img13.360buyimg.com/da/20120221/112_40_WvArIl.png"></A></DIV></DIV></DIV><!-- footer end -->
<SCRIPT type=text/javascript>
