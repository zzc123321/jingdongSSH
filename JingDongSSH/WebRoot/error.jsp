...
<DL>
  ...
  href="http://jd2008.360buy.com/purchase/ShoppingCart.aspx"><img src="image/gouwuchejiezhang.jpg"/></A> 
  </DT>
  <DD>
  <DIV class=prompt>
...
<div id="msg" style="font-size:13px;font-family:Arial,Verdana;color:#333333;position:relative;height:50px;text-align: center;min-width: 990px;line-height: 50px;"> 
	操作错误 , 系统会在 <span id="number">5</span> 秒后自动跳转到首页 . 如果没有跳转 则点击这里 <a href="/JingDong/index.jsp" style="color: #CC0000;"> 返回首页 </a>
</div>

<div id="content" style="background:url('<%=path%>/image/bgerror.jpg');margin:0 auto;width: 790px;padding-left:200px">
  	<img alt="错误页面" src="image/error.jpg"/>
</div>
