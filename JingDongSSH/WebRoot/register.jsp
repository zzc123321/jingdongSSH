...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="css/passport1.css"/>
    <link type="text/css" rel="stylesheet" href="css/regist001.css"/>
    
    <style type="text/css">
    	.user{width:250px;height:25px;font-size:40px;font-weight:200;color:#333;}
    	#authcode{height:25px;width:80px;font-weight:200px;color:#333;}
    </style>
		...
		function checkRegister(){
			...
			*/
			...
			/**
				...
				. 代表 任意一个对象
			*/
			var regexEmail = /^\w+@\w+[.](com||cn|com.cn||org||gov)$/g;
...
<div class="w" id="logo">
    <div><a href="http://www.360buy.com/"><img src="image/logo00001.gif" alt="京东商城" width="167" height="46"/></a>
    </div>
</div>
...
<div class="mt">
    <h2>
        注册新用户</h2>
    <b></b><span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="javascript:location.href=&quot;http://passport.360buy.com/new2/global/switchlanguage.aspx?l=en&amp;ReturnUrl=http://passport.360buy.com/new2/registpersonal.aspx&quot;+location.search;" href="https://passport.360buy.com/new/registpersonal.aspx#">English</a></span> <span>我已经注册，现在就&nbsp;<a href="<%=path%>/login.jsp" class="flk13">登录</a></span>
</div>
<div class="mc">
<ul class="tab">
    <li class="curr">个人用户</li>
    <li class="line"><a href="https://passport.360buy.com/new/registcompany.aspx">企业用户</a></li>
    <li><a href="https://passport.360buy.com/new/registschool.aspx">校园用户</a></li>
</ul>

<form id="formpersonal" method="post" action="<%=path%>/users/RegisterAction" onsubmit="return checkRegister()">
    <div class="form">
        <div class="item">
            <span class="label"><b class="ftx04">*</b>用户名：</span>

            <div class="fl">
                <input type="text" id="username" name="username" class="user" tabindex="1"/>
                <label id="username_succeed" class="blank"></label>
                <span class="clr"></span>

             <div id="username_error" style="color: red;">${info}</div>
        ...
        <div id="o-password">
            <div class="item">
                ...
                <div class="fl">
                    <input type="password" id="pwd" name="pwd" class="user" tabindex="2"/>
            ...
            <div class="item">
                ...
                <div class="fl">
                    <input type="password" id="pwd2" name="pwd2" class="user" tabindex="3"/>
        ...
        <div class="item">
            ...
            <div class="fl">
                <input type="text" id="mail" name="mail" class="user" tabindex="4"/>
        ...
        <div class="item">
            ...
            <div class="fl">
                <input type="text" id="authcode" style="ime-mode:disabled" name="authcode" tabindex="6" autocomplete="off" maxlength="6"/>
                <label class="image">
                    <img style="cursor:pointer;width:100px;height:26px;" alt="" onclick="this.src='JDVerification.aspx?a=0&amp;uid=fceede4a-932c-4274-a370-009e683850a1&amp;yys='+new Date().getTime()" ver_colorofnoisepoint="#888888" id="JD_Verification1" src="image/JDVerif1i.jpg"/> </label>
        ...
        <div class="item">
            ...
            <input type="image" src="image/xieyi.bmp" class="btn-image btn-regist" id="registsubmit" value="494d" tabindex="8"/>
        </div>
...
<p>
    本协议依据国家相关法律法规规章制定，用户同意严格遵守以下义务：</p>
...
<div class="w">
    <div id="footer">
        ...
        <div class="authentication"><a href="http://www.hd315.gov.cn/beian/view.asp?bianhao=010202007080200026" target="_blank"><img src="image/f_icp0001.gif" width="108" height="40" alt="经营性网站备案中心"/></a>
            <a href="https://ss.cnnic.cn/verifyseal.dll?sn=2008070300100000031&amp;pa=294005" tabindex="-1" id="urlknet" target="_blank"><img name="seal" border="true" src="image/d2.jpg" width="112" height="40" oncontextmenu="return false;" onclick="change('urlknet')" alt="可信网站"/></a><a href="http://fzp.bjhd.gov.cn/Default.aspx?TabId=105" target="_blank"><img src="image/f_hdwj001.jpg" width="108" height="40" alt="海淀网络警察"/></a><a href="https://search.szfw.org/cert/l/CX20120111001803001836" target="_blank"><img src="image/d4.jpg" width="112" height="40"/></a></div>
    </div>
</div>
