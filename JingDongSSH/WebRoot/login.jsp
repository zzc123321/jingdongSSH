...
<div id="shortcut">
	<div class="w">
			...
			<li class="fore6 menu" data-widget="dropdown">
				<dl>
					...
					<dd>
						...
						<div><a href="http://www.52itstyle.com/contact/service.html" target="_blank">客服邮箱</a></div>
					</dd>
				</dl>
			</li>
		</ul>
        ...
        <div><a href="http://www.52itstyle.com/"><img src="image/logo0000.gif" alt="京东商城" width="167" height="46"/></a></div>
    </div>
    ...
    <div class="w" id="entry">
        <div class="mt" id="li_3">
            <h2>用户登录</h2>
            <b></b>
            <span style="text-align:right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="javascript:location.href=&quot;http://passport.360buy.com/new2/global/switchlanguage.aspx?l=en&amp;ReturnUrl=http://passport.360buy.com/new2/login.aspx&quot;+location.search;" href="https://passport.360buy.com/new/login.aspx?ReturnUrl=http%3A%2F%2Fwww.52itstyle.com%2F#">English</a></span>
        </div>
