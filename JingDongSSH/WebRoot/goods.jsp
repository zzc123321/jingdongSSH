...
<!-- saved from url=(0041)http://www.52itstyle.com/product/288725.html -->
...
<SCRIPT type=text/javascript>window.pageConfig = { compatible: true}; </SCRIPT>
	...
	<style type="text/css">
		#info{width:1000px;margin:0 auto;padding:50px 0px;border:0;font-size:12px;text-align:center;}
		#tr_1{font-size:16px;font-weight:600;color:#FF0000;}
		#tr_2 img{width:280px;height:300px;}
		#tr_3{text-align:left;}
		#td_3{font-size:14px;}
		#tr_4{text-align:left;}
		#td_4{font-size:15px;color:red;font-weight:600;}
		#tr_5{text-align:left;width:100px;}
		#tr_5 a{color:blue;}
		#tr_6{text-align:left;}
		#img_2{padding-left:10px;}
	</style>
...
<UL class="fr lh">
  ...
  <DL>
    ...
    <DIV><A href="http://www.52itstyle.com/contact/service.html" 
    target=_blank>客服邮箱</A></DIV></DD></DL></LI></UL><SPAN 
class=clr></SPAN></DIV></DIV><!--shortcut end-->
<DIV id=o-header>
<DIV class=w id=header>
<DIV class=ld id=logo><A href="http://www.52itstyle.com/"><B></B><IMG height=50 
...
<DIV id=my360buy>
<DL>
  <DT class=ld><S></S><IMG height=24 src="<%=path%>/image/blank.gif" 
  width=24><A href="http://home.360buy.com/"><img src="<%=path%>/image/wodejingdnog.jpg" alt="我的京东"/></A><B></B> </DT>
  <DD>
  <DIV class=loading-style1><B></B>加载中，请稍候...</DIV></DD></DL></DIV><!--my360buy end-->
<DIV id=settleup>
<DL>
  <DT class=ld><S><SPAN id=shopping-amount></SPAN></S><A 
  href="http://jd2008.360buy.com/purchase/ShoppingCart.aspx"><img src="<%=path%>/image/gouwuchejiezhang.jpg" alt="去购物车结账"/></A> 
  <B></B></DT>
  <DD>
  <DIV class=prompt>
...
<DIV id=categorys>
<DIV class="mt ld">
<H2><A href="http://www.52itstyle.com/allSort.aspx">全部商品分类<B></B></A></H2></DIV>
...
<H3><A 
href="http://www.52itstyle.com/electronic.html">家用电器</A></H3><S></S></SPAN></DIV>
<DIV class="item fore3"><SPAN>
<H3><A 
href="http://www.52itstyle.com/digital.html">手机数码</A></H3><S></S></SPAN></DIV>
<DIV class="item fore4"><SPAN>
<H3><A 
href="http://www.52itstyle.com/computer.html">电脑、办公</A></H3><S></S></SPAN></DIV>
<DIV class="item fore5"><SPAN>
<H3><A href="http://www.52itstyle.com/home.html">家居家装</A>、<A 
href="http://www.52itstyle.com/kitchenware.html">厨具</A></H3><S></S></SPAN></DIV>
<DIV class="item fore6"><SPAN>
<H3><A 
href="http://www.52itstyle.com/clothing.html">服饰鞋帽</A></H3><S></S></SPAN></DIV>
<DIV class="item fore7"><SPAN>
<H3><A 
href="http://www.52itstyle.com/beauty.html">个护化妆</A></H3><S></S></SPAN></DIV>
<DIV class="item fore8"><SPAN>
<H3><A href="http://www.52itstyle.com/bag.html">礼品箱包</A>、<A 
href="http://www.52itstyle.com/watch.html">钟表</A>、<A 
href="http://www.52itstyle.com/jewellery.html">珠宝</A></H3><S></S></SPAN></DIV>
<DIV class="item fore9"><SPAN>
<H3><A 
href="http://www.52itstyle.com/sports.html">运动健康</A></H3><S></S></SPAN></DIV>
<DIV class="item fore10"><SPAN>
<H3><A href="http://www.52itstyle.com/auto.html">汽车用品</A></H3><S></S></SPAN></DIV>
<DIV class="item fore11"><SPAN>
<H3><A href="http://www.52itstyle.com/baby.html">母婴</A>、<A 
href="http://www.52itstyle.com/toys.html">玩具乐器</A></H3><S></S></SPAN></DIV>
<DIV class="item fore12"><SPAN>
<H3><A 
href="http://www.52itstyle.com/food.html">食品饮料、保健食品</A></H3><S></S></SPAN></DIV>
...
href="http://www.52itstyle.com/products/4938-4943-000.html">票务</A></H3><S></S></SPAN></DIV>
<DIV class=extra><A 
href="http://www.52itstyle.com/allSort.aspx">全部商品分类</A></DIV></DIV></DIV>
<DIV id=treasure></DIV>
<UL id=navitems>
...
<div id="info">
		<table>
			...
			<tr id="tr_1">
				<td colspan="3">${goods.title}</td>
			</tr>
			
			<tr id="tr_2">
				<td rowspan="5"><img src="<%=path%>/${goods.imgURL}"/></td>
			</tr>
			
			<tr id="tr_3">
				<td width="60px;">市场价：</td>
				<td id="td_3">￥ ${goods.price * 2 - 150}</td>
			</tr>
			
			<tr id="tr_4">
				<td>京东价：</td>
				<td id="td_4"><img src="<%=path%>/image/qian.jpg"/>${goods.price}</td>
			</tr>
			
			<tr id="tr_5">
				<td>商品评价：</td>
				<td><img src="<%=path%>/image/xingxing.jpg"/><a href=""> (已有${goods.evaluate}人评价)</a></td>
			</tr>
			
			<tr id="tr_6">
				<td colspan="2"><a href="<%=path%>/goods/BuyGoodsAction?id=${goods.id}"><img src="<%=path%>/image/jiarugouwuche.jpg"/></a><img id="img_2" src="<%=path%>/image/guanzhu2.jpg"/></td>
			</tr>		
		</table>	
	</div>
...
<DIV class=w>
<DIV id=footer>
<DIV class=links><A href="http://www.52itstyle.com/intro/about.aspx" 
target=_blank>关于我们</A>|<A href="http://www.52itstyle.com/contact/" 
target=_blank>联系我们</A>|<A href="http://zhaopin.360buy.com/" 
target=_blank>人才招聘</A>|<A href="http://www.52itstyle.com/contact/joinin.aspx" 
target=_blank>商家入驻</A>|<A href="http://www.minitiao.com/" 
target=_blank>迷你挑</A>|<A href="http://www.360top.com/" target=_blank>奢侈品网</A>|<A 
href="http://www.52itstyle.com/intro/service.aspx" target=_blank>广告服务</A>|<A 
...
target=_blank><IMG height=40 alt=经营性网站备案中心 width=108 
src="<%=path%>/image/d1.jpg"/></A>
...
<SCRIPT src="<%=path%>/js/lib-v1.js" type=text/javascript></SCRIPT>

<SCRIPT src="<%=path%>/js/p.pshow20110623.js" type=text/javascript></SCRIPT>

<SCRIPT src="<%=path%>/js/promotion.js" type=text/javascript></SCRIPT>

<SCRIPT type=text/javascript>GetSingleAdWord('0D16CDDBE79F119FEFFD5A381EA0738A');</SCRIPT>

<SCRIPT src="<%=path%>/js/ref_spider.min.js" type=text/javascript></SCRIPT>
...
<SCRIPT src="<%=path%>/js/BiForWeb.T.js" type=text/javascript></SCRIPT>
<!--推荐-->
...
<SCRIPT src="<%=path%>/js/wl.js" type=text/javascript></SCRIPT>
...
<SCRIPT src="<%=path%>/js/conversion.js" type=text/javascript>
    </SCRIPT>
<NOSCRIPT>
